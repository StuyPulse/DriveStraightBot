 ...
 */
public class EncoderStraightDrivingCommand extends AutoMovementCommand {
    ...
    public EncoderStraightDrivingCommand(double inches) {
        super();
        this.inches = inches;
    ...
    protected void initialize() {
        try {
            ...
            initialInchesToMove = set? SmartDashboard.getNumber("encoder-drive-inches", 0.0) : inches;
