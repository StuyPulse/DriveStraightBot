...
public class DriveStraightPIDRampingCommand extends PIDCommand {

	private double speed, distance;
	private boolean auto;

    public DriveStraightPIDRampingCommand(double speed, double distance) {
    	super(0.0,0.0,0.0);
		this.speed = speed;
    ...
    public DriveStraightPIDRampingCommand() {
        this(0.0,0.0);
        auto = true;
    }
